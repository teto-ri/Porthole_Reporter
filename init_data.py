...
category_color_map = {"차량 사고": "red", "도로 막힘": "orange", "포트홀": "blue"}
status_opacity_map = {
...
def get_sample_data(seed, n):
    ...
    detail_locations = [
        base + str(random.randint(1, 100))
        for base in random.choices(detail_locations_base, k=num_items)
    ]

    # Generate random locations around Daegu's coordinates
    locations = [
        (random.uniform(35.8, 35.95), random.uniform(128.5, 128.7))
